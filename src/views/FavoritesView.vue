...
// 检查房源是否有"近地铁"标签
const hasSubwayLabel = (item: typeof favoriteStore.favorites[0]): boolean => {
...
// 提取房型的面积范围
const getFormattedArea = (item: typeof favoriteStore.favorites[0]): string | null => {
  ...
  <div class="min-h-screen bg-gray-50">
    <div class="container-app py-4 md:py-6">
      ...
      <div class="flex items-center justify-between mb-4 md:mb-6">
        <div>
          <h1 class="text-xl md:text-2xl font-bold text-gray-800 mb-1 md:mb-2">我的收藏</h1>
